...
```bash
mn1 127.0.0.2:37521 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0
```

The format for this string is as follow:
```bash
masternodealias publicipaddress:37521 masternodeprivatekey output-tx-ID output-tx-index
```
...
__publicipaddress:37521__ - this must be your masternode public IP address, which is usually the IP address of your VPS, accessible from the Internet. The new script (v1.1) will detect your IP address automatically. The __:37521__ suffix is the predefined and fixed TCP port which is being used in the Retrex network for node-to-node and wallet-to-node communications. This port needs to be opened on your VPS server firewall so that others can talk to your masternode. The setup script takes care of it. NOTE: some VPS service providers may have additional firewall on their network which you may need to configure to open TCP port 37521. Vultr does not require this.
...
===========================================================================
95.171.6.105:37521    118   6818/7929  2586   3706   3706    2361   0
24.176.52.93:37521    37    5770/6829  2614   3706   3706    2301   0
38.103.14.19:37521    8     9787/8024  2657   3706   3706    2208   0
===========================================================================
